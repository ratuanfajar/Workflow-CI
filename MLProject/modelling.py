...
def train():
    ...
    train_path = BASE_DIR / "Membangun_model\\student_performance_preprocessing\\train.csv"
    test_path  = BASE_DIR / "Membangun_model\\student_performance_preprocessing\\test.csv"
